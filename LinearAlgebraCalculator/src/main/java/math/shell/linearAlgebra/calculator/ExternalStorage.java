...
/**
 *	Methods that deal with reading and writing the calculators external storage, stored in "calculator_storage.txt"
 *	@author Avraham Katz
 *	@version 1.0
 */
...
public class ExternalStorage
{
    ...
    /**
     *	When exit program, converts all Matrices in calculator internal storage (InternalStorage.Singleton) to their string represenation and stores them in external file "calculator_storage.txt"
     */
    ...
    /**
     *	When open program, any Matrices in string represenation in external file "calculator_storage.txt" converted to Matrix object, and stored with associated variables in calculator internal storage (InternalStorage.Singleton)
     */
    public static void readExternalStorage()
    {
        ...
        try
        {
            ...
            if (line == 0)
            {
                System.out.printf("No matrices in storage. Must create at least 1 matrix to do any operations. %nIf needs to reference format to create matrix, enter 'frmt' to go to operations and format menu, enter '17', and will display how to create a new matrix %n%n");
                fr.close();
                br.close();
            }
            ...
            {
                System.out.printf("You have the following matrices from input file in your storage currently... %n%n");
