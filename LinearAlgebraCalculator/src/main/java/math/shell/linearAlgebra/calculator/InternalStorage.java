...
/**
 *	A container that holds Matrices, mapping variable names to Matrices
 *	@author Avraham Katz
 *	@version 1.0
 */
...
public class InternalStorage
{
    ...
    /**
     *	Adds a Matrix to the container, mapping it to a specific variable name
     ...
     *	@return Matrix Matrix getting from storage
     */
    ...
    /**
     *  Clears the internal storage of all variables and Matrices
     */
    public void clear()
    {
    ...
    /**
     * Determines if the internal storage is empty or not
