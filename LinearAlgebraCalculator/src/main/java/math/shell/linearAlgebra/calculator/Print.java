...
public class Print
{
    ...
    public static void printMatrix(Matrix matrix)
    {
        ...
        for (int i = 0; i < matrix.getColumnHeight(); i++)
        {
            ...
            {
                BigDecimal nextOutput = matrix.getWrappedMatrix()[i][j];//.setScale(5, BigDecimal.ROUND_HALF_EVEN);
    ...
    /**
     *	Prints a specific Matrix from the storage by variable name
    ...
    public static void printEquation(String string)
    {
        ...
        if (!finalString.contains("strg") && !finalString.contains("=") && !finalString.equals("frmt") && !finalString.equals("exit") && !finalString.equals("clearinternalstorage"))
        {
            ...
            System.out.println();
            System.out.println(InterfaceMethods.bump + finalString + "=");
        }
    }
