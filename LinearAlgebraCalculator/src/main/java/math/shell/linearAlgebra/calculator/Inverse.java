...
public class Inverse
{
     ...
     * 	@param inverseMatrix Matrix that will be converted into the inverse matrix
     *	@param row Number of row
     *	@see resume.linear_algebra.calculator3.GaussianElimination#clearValuesBelowLeadingOne(BigDecimal[][], int)
     */
     ...
     *	@see resume.linear_algebra.calculator3.GaussianElimination#clearValuesAboveLeadingOne(BigDecimal[]][], int)
     */
     ...
     *	@see resume.linear_algebra.calculator3.GaussianElimination#rowEchelonForm(Matrix)
     */
     ...
     *	@see resume.linear_algebra.calculator3.GaussianElimination#reducedRowEchelonForm(Matrix)
     */
